    ...
    <>
      ...
      <Stack p={{ xs: "15px", sm: "25px", md: "40px", lg: "60px " }}>
        ...
        <Box mt="25px">
          ...
          <Box className="icons">
            <Link to="https://www.instagram.com/_.rohitttt">
              <Instagram
            ...
            <Link to="https://www.facebook.com/rohit.yaduvanshi.7186">
            ...
            <Link to="https://www.linkedin.com/in/lalit-yadav-aa4472193/">
              <LinkedInIcon
                sx={{ fontSize: "40px", paddingLeft: "15px" }}
                color="primary"
              />
            ...
            <Link to="https://twitter.com/Lalityadav008">
              <TwitterIcon
                sx={{ fontSize: "40px", paddingLeft: "15px" }}
                color="info"
              />
            </Link>
            <Link to="https://github.com/Lalityadav08">
              <GitHub
